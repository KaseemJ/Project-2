...
VALUES (1, '2004 GMC Sierra', 21999.99, 'A White 2004 GMC Sierra with 100,000 miles on it, needs new tires.', 'San Diego, Ca', 'https://static.tcimg.net/vehicles/primary/c0f2b391df4555f5/2018-GMC-Sierra_2500HD-white-full_color-driver_side_front_quarter.png', 'Vehicles');
INSERT INTO `items` (user_id, item_name, item_price, item_description, item_location, item_img_url, item_category)
...
INSERT INTO `items` (user_id, item_name, item_price, item_description, item_location, item_img_url, item_category)
VALUES (2, 'Bengal TIger', 50000.01, 'A Freaking Tiger.', 'Las Vagas, Nv', 'https://cdn.earlytorise.com/wp-content/uploads/2008/04/white-bengal-tiger.jpg', 'Exotic Pets');
INSERT INTO `items` (user_id, item_name, item_price, item_description, item_location, item_img_url, item_category)
VALUES (3, 'Aston Martin', 250000.00, 'Totally doesnt have an ejection seat.', 'London, En', 'http://www.jamesbondlifestyle.com/sites/default/files/ckeditor/images/news/crne-am-db5-auction-large.jpg', 'Vehicles');
INSERT INTO `items` (user_id, item_name, item_price, item_description, item_location, item_img_url, item_category)
